...
function informacao (nome: string, ano: number, genero: GENERO , pontuacao?: number):Ficha {
    return {
		nome: nome, 
		anoLancamento: ano, 
		genero: genero, 
...
console.log(informacao(filme.nome, filme.anoLancamento, filme.genero, filme.pontuacao))